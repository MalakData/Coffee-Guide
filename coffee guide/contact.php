...
if(isset($_POST['con']))
{
	...
	if(mysqli_query($con, "INSERT INTO contact (Name,Email,subject,message) 
		...
		<div class="container">
			...
			<div class="map-grids">
				...
				<div class="col-md-9 contact-left">
					<h3 style="color:#E8BB2E;">Contact Form</h3>
					<div class="line minus1"> 
					</div>
					<form method="post" action="" >
						<input  type="text" name="Name" value="Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Name';}" required="" style="color:#799F61;">
						...
						<input type="text" name="subject" value="Subject" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Subject';}" required="" style="color:#799F61;">
						<textarea type="text" name="message"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Message...';}" required="" style="color:#799F61;">Message...</textarea>
						<input type="submit" value="Submit" name="con" >
					</form>
				</div>
