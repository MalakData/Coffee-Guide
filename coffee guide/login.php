...
if(isset($_POST['log']))
{
	...
	if(mysqli_query($con, "INSERT INTO login (Email,password) 
    VALUES('".$email."','".$pass."')"))
	{
            $msg = 'Congratulation you have successfully login.';
		...
		<div class="container">
			...
			<div class="map-grids">
                <div class="col-md-3 contact-left"> 
                        <h3 style="color:#E8BB2E;">More Info:</h3>
					<div class="line minus"> 
					</div>
					<ul>
                        <li>1.You Can Create New Account By Click<a href="register.php">  HRERE</a></li>
						<li>2.Telephone :+1 078 4589 2456</li>
						<li>3.Fax :+1 078 4589 2456</li>
						<li><a href="mailto:info@example.com">4.info@gmail.com</a></li>
					</ul>
				</div>
				<div class="col-md-9 contact-left">
					<h3 style="color:#E8BB2E;">Login</h3>
